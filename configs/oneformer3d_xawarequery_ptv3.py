"""
ForestFormer XAwarequery with PTV3 Backbone

Identical to oneformer3d_qs_radius16_qp300_2many.py (baseline) except backbone
is swapped from SpConvUNet to PTV3. Enables fair backbone-only comparison.
"""
_base_ = [
...
# model settings
num_channels = 64  # PTV3 output channels
...
model = dict(
    type='ForAINetV2OneFormer3D_XAwarequery_PTV3',
